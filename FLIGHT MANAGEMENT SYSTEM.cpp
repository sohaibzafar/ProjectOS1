...
using namespace std;
   ...
   char l_destination[5][20]={"LAHORE","ISLAMABAD","KARACHI","PESHAWAR","QUETTA"};
       char i_destination[10][20]={"LONDON","BERLIN","DUBAI","NEW YORK","BEIJING","PARIS","CAPE TOWN","TOKYO","LOS ANGELES","TORONTO" };
class mytime
{
protected:
 int choose;
 ...
 void getdata()
 {
  ...
  cout<<"\n\n\nEnter the firstname of passenger: ";
   ...
   cin.getline(c_loc,60);
    for(int s=0;s<strlen(c_loc);s++)
   {
   	c_loc[s]=toupper(c_loc[s]);
   }
   cout<<endl<<endl;
   cout<<"Enter the destination of passenger(IN CAPITAL LETTERS ONLY):  ";
   cin.getline(dest,60);
   for(int s=0;s<strlen(dest);s++)
   {
   	dest[s]=toupper(dest[s]);
   }
   desti=dest;
   cout<<endl<<endl;
   system("CLS");
...
void searching()
 {
  cout<<"FOLLOWING ARE THE INTERNATIONAL FLIGHTS AVAILABLE TODAY:\n\n"<<endl;
  ...
  cout<<"\n\n\nFOLLOWING ARE THE DOMESTIC FLIGHTS AVAILABLE TODAY:\n\n"<<endl;
...

{
    ...
    else
 {
   ...
   
   {
      ...
      float price;	
		if(booking::getdest()=="KARACHI")
	{
					price=14000;
}
		else if(booking::getdest()== "LAHORE")
		{
		
		price=13000;
		}
		else if(booking::getdest()== "QUETTA"){
		
		price=11000;
		}
		else if(booking::getdest()== "ISLAMABAD"){
		
			price=15000;
		}
		else if(booking::getdest()== "PESHAWAR"){
    ...
    cout<<"|"<<flight<<"                                                              "<<endl;
    cout<<"|Ticket Price: "<<price<<" PKR only/=                                     "<<endl;
    ...
    outfile<<"|                                                                         "<<endl<<
             ...
             "|BUISNESS CLASS                                                           "<<endl<<
             "|"<<flight<<"                                                             "<<endl<<
             "|Ticket Price: "<<price<<" PKR only/=                                     "<<endl;
   }
...

{
   ...
   else
 {
  ...
  {
  	float price;
		if(booking::getdest()=="LONDON")
	{
					price=60000;
}
		else if(booking::getdest()== "NEW YORK")
		{
		
		price=90000;
		}
		else if(booking::getdest()== "BERLIN"){
		
		price=69000;
		}
		else if(booking::getdest()== "TORONTO"){
		
			price=85000;
		}
		else if(booking::getdest()== "PARIS"){
		
		price=100999;
	}
		else if(booking::getdest()== "BEIJING"){
		
		price=40000;
	}
	else if(booking::getdest()== "DUBAI"){
		
		price=25000;}
		
		else if(booking::getdest()== "CAPE TOWN"){
		
		price=60000;}
		
		else if(booking::getdest()== "TOKYO"){
		
		price=45000;}
		
		
		else if(booking::getdest()== "LOS ANGELES"){
...
m:
  ...
  system("cls");
   ...
   case 1:
    ...
    cin>>back;
    back = tolower(back); //in case its B instead of b
...
{ SetConsoleTitle("AIRWAYS RESERVATION");
 ...
 cout<<"\n\n\n\n\n\n\n\t          DEVELOPED BY :";
 Sleep(1500);
  cout<<"\n\n\tSYED ABDUL MUQEET MANSOOR \t SOHAIB ZAFAR";
  Sleep(1500);
  cout<<"\n\n\n\tHUZAIFA IRFAN           \t ALI SHERJEEL KAZMI";
 Sleep(3000);
 system("cls");
 main1 m1;
 m1.getdata();
